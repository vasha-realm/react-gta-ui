...
const GasAndEnginePanel = (gasAndEnginePanelProps: GasAndEnginePanelProps) => {
  ...
  return (
    <div className={`${classNames}`}>
      ...
      {/* gas icon */}
      <svg viewBox="0 0 512 512" className="absolute bottom-[10%] left-[20%] -translate-x-1/2 translate-y-1/2 w-[1rem] aspect-square fill-white">
      ...
      {/* engine icon */}
      <svg viewBox="0 0 512 512" className="absolute bottom-[10%] right-[20%] translate-x-1/2 translate-y-1/2 w-[1rem] aspect-square fill-white">
...
const SpeedPanel = (speedPanelProps: SpeedPanelProps) => {
  ...
  const speedPrefix = useMemo(() => {
    if (speed < 10) return '00'
  ...
  return (
    <div className={`${classNames}`}>
      ...
      <div className="absolute size-full flex flex-col items-center justify-center">
        <span className="text-[.5rem]">MPH</span>
        <NumberLed num={String(speed)} prefix={speedPrefix} classNames="h-[2.5rem] mb-[1rem]" />
        <div className="border-[.1rem] rounded-full w-[2rem] aspect-square flex items-center justify-center">
      ...
      {/* speed marks */}
      <NumberLed num={`10`} style={{ top: `${50 + 20}%`, left: `${50 - getSqrt(30, 20)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
      <NumberLed num={`210`} style={{ top: `${50 + 20}%`, left: `${50 + getSqrt(30, 20)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />

      <NumberLed num={`30`} style={{ top: `${50 + 10}%`, left: `${50 - getSqrt(30, 10)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
      <NumberLed num={`190`} style={{ top: `${50 + 10}%`, left: `${50 + getSqrt(30, 10)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />

      <NumberLed num={`50`} style={{ top: `${50 - 3}%`, left: `${50 - getSqrt(30, 3)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
      <NumberLed num={`170`} style={{ top: `${50 - 3}%`, left: `${50 + getSqrt(30, 3)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />

      <NumberLed num={`70`} style={{ top: `${50 - 15}%`, left: `${50 - getSqrt(30, 15)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
      <NumberLed num={`150`} style={{ top: `${50 - 15}%`, left: `${50 + getSqrt(30, 15)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />

      <NumberLed num={`90`} style={{ top: `${50 - 25}%`, left: `${50 - getSqrt(30, 25)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
      <NumberLed num={`130`} style={{ top: `${50 - 25}%`, left: `${50 + getSqrt(30, 25)}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />

      <NumberLed num={`110`} style={{ top: `${50 - 30}%`, left: `${50}%` }} classNames="absolute -translate-x-1/2 -translate-y-1/2 h-[.5rem]" />
    </div>
  )
